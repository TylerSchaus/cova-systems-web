    ...
    >
      ...
      >
        ...
        <button
          ...
          className="flex md:hidden items-center justify-center p-2 text-gray-700"
    ...
    <AnimatePresence>
      {mobileMenuOpen && (
        <>
          ...
          {/* Menu panel */}
          <motion.div
            className="fixed top-0 right-0 h-full w-[75%] max-w-xs bg-white z-50 flex flex-col md:hidden shadow-2xl"
            initial={{ x: "100%" }}
            animate={{ x: 0 }}
            exit={{ x: "100%" }}
